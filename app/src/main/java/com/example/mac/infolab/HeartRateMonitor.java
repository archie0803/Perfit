...
/**
 * Created by vr_pai on 05-07-2016.
 */
...
public class HeartRateMonitor extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String strSavedDoctorID = HeartRateMonitor.this.getSharedPreferences("app_prefs", MODE_PRIVATE)
                .getString("doc_id", "---");
    ...
    private static void showReadingCompleteDialog() {
        ...
        builder.setTitle("HeartRateMonitor");
